...
<div class="enterNameFrom">
  <el-form @submit.native.prevent :model="activityPlanForm" :rules="dataRule" :inline="false"  ref="activityPlanForm" label-width="110px" class="demo-ruleForm">
    ...
    <el-form-item label="活动价格"  prop="price">
      <el-input v-model="activityPlanForm.price" autocomplete="off"></el-input>
    </el-form-item>
    ...
    <el-form-item>
      <div>
        <map-box :lat="activityPlanForm.lat" :lng="activityPlanForm.lng" :address="activityPlanForm.address" @chooseAddressPoint="chooseAddressPoint" ref="myMap"></map-box>
      </div>
    </el-form-item>
    <el-form-item label="主图">
      <upload @fileChange="chooseImg" class="avatar-uploader" :width="343" :height="204" style="width: 172px;height: 80px; line-height: 80px">
        <img v-if="activityPlanForm.mainImgUrl" :src="activityPlanForm.mainImgUrl" class="avatar">
...
export default {
  ...
  methods: {
    init({ data }) {
      ...
      this.activityPlanForm.id = data.id
      this.$http({
        ...
        this.activityPlanForm.mainImgUrl = data.data.mainImgUrl
        ...
        this.activityPlanForm.phoneNum = data.data.phoneNum ? data.data.phoneNum : ''
        ...
        this.activityPlanForm.attention = data.data.attention
    ...
    // 选择图片
    chooseImg(data) {
      this.activityPlanForm.mainImgUrl = data
    },
