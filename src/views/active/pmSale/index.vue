      ...
      <el-col :span="24">
        <el-card shadow="never">
          ...
          <el-table :data="tableList" v-loading="listLoading" element-loading-text="拼命加载中">
            ...
            <el-table-column v-if="this.$cookie.get('moduleType') != this.$cookie.get('promoduleType')" prop="charger" label="负责人" align="center" header-align="center" />
            <el-table-column prop="showToC" label="状态" align="center" header-align="center">
              <template slot-scope="scope">
                ...
                :activityType="301"
                :approveStatus="scope.row.approveStatus"
