...
export const asyncRoutes = [
  ...
  // 城市与B端管理
  {
    ...
    name: 'Module',
    meta: { title: '城市管理', icon: '城市管理', roles: ['/module/listNext','/activityTop/list',
     '/moduleCity/listNextAll', '/groupBanner/listAll', '/hotActivity/list', '/hotShop/groupList',
     '/hotShop/listShopByCityId','/happyDay/list'] },
    children: [{
      path: 'listModule',
      name: 'city',
      component: () =>
    ...
    {
      path: 'happyDayActivity',
      name: 'happyDayActivity',
      component: () =>
        import('@/views/module/listModule/happyDayActivity'),
      meta: { title: '狂欢活动节', roles: ['/happyDay/list']},
    },
    {
      path: 'hotShop',
      name: 'hotShop',
  ...
  // 审批管理
  {
    ...
    name: 'approval',
    meta: { title: '活动管理', icon: '城市管理', roles: ['/showToCApproval/list', '/approveActivity/list', '/activityPlan/surplus'] },
    children: [
      {
        ...
        meta: { title: '上架审批', icon: '城市管理' , roles: ['/showToCApproval/list'] }
      },
      {
        path: 'approvalActiveChangeList',
        name: 'approvalActiveChangeList',
        component: () =>
          import('@/views/approval/changeList'),
        meta: { title: '修改审批', icon: '城市管理' , roles: ['/approveActivity/list'] }
      },
      {
        path: 'surplus',
        name: 'surplus',
  ...
  // 活动管理
  {
    ...
    name: 'shop',
    meta: { title: '活动管理', icon: '活动管理', roles: ['/activityTemplate/findByType', '/findLottery/findList', '/coupon/list',
    '/pmSale/list', '/groupBuy/list', '/enterName/list', '/activityPlan/list',
    '/moneyApproval/listOrderRefund', '/diffTrades/listSelf', '/outCoupon/list','/shopProduct/listByOwnerId'] },
    children: [
      {
        path: '/coupon',
        name: 'coupon',
      ...
      },
      {
        ...
        name: 'shopProduct',
        component: () =>
          import('@/views/active/shopProduct/index'),
         meta: { title: '电商商品管理', roles: ['/shopProduct/listByOwnerId']}
      },
      {
        path: '/standardsTab/:id(\\d+)',
        component: () => import('@/views/active/shopProduct/standardsTab'),
        name: 'standardsTab',
        meta: { title: '电商商品规格管理', noCache: true, activeMenu: '/shopProductsku/listAll' },
        hidden: true
      },
      {
        path: '/orderManage/:id(\\d+)',
        component: () => import('@/views/active/shopProduct/orderManage'),
        name: 'orderManage',
        meta: { title: '电商商品订单管理', noCache: true, activeMenu: '/shopProductOrder/orderList' },
        hidden: true
      },
      {
        path: '/activerefund',
