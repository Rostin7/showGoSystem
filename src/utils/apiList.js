...
api.module = {
  ...
  // 狂欢活动商品管理
  happyDayManage: {
    add: '/happyDay/addProduct',
    del: '/happyDay/removeProduct',
    list: '/happyDay/listProduct'
  },
  // 店铺管理
  moduleShop: {
    add: '/moduleShop/add',
...
// 电商商品管理
api.shopProduct = {
    getData: '/shopProduct/getById',
    list : '/shopProduct/listByOwnerId',
    add: '/shopProduct/add',
    edit: '/shopProduct/mod',
    del: '/shopProduct/del',
  },
//电商商品订单管理
api.shopProductOrder = {
  list : '/shopProductOrder/orderList',             //列表，包括状态筛选
  sendGoods: '/shopProductOrder/sendOrder',         //发货，只有付款成功的订单可以发货
  edit: '/shopProductOrder/modSendOrder',           //物流信息修改，发货后可修改
  closeOrder: '/shopProductOrder/moduleCloseOrder', //商户关闭订单，未付款30分钟后可关闭
  getCommodity: '/shopProductOrder/moduleSureOrder',//商户确认收货，已发货订单并且创建后七天可确认
  dealPayBack:'/shopProductOrder/refundOrder',      //商户处理退款申请，申请退款中订单可处理。同意则全额退款
  handPayBack: '/shopProductOrder/refundAfterSendOrder'  //商户手动退款，支付完成订单可操作：无理由退款
}
  // 商城商品规格管理
api.shopProductsku = {
    list : '/shopProductsku/listAll',
    add: '/shopProductsku/add',
    edit: '/shopProductsku/mod',
    del: '/shopProductsku/del',
  }
export default api
